...
- `app/public/grid_assets.json`: Şebeke GeoJSON'u (Hassas veri içermemesi için içi boşaltılmıştır).
...
Proje kaynak kodları **[MIT Lisansı](LICENSE)** ile lisanslanmıştır.
Uygulamada kullanılan veri setlerinin kullanım, yeniden dağıtım ve lisans koşulları için lütfen **[Veri Lisansı (DATA_LICENSE.md)](DATA_LICENSE.md)** dosyasını okuyun.

> **Gizlilik Bildirimi**: Harita altlıkları (OSM, CARTO, Esri) ve 3D arazi verileri (AWS) üçüncü taraf servislerden yüklenmektedir. Bu servislere yapılan isteklerde IP adresiniz ilgili sağlayıcılara iletilebilir.
